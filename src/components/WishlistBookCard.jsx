      ...
      <div className="flex flex-col gap-2 flex-1">
        ...
        <div className="flex items-center gap-3 flex-wrap">
          ...
          <Link to={`/bookDetails/${bookId}`}>
            <button className="bg-[#59C6D2] hover:bg-[#47b3bf] text-white px-4 py-1.5 rounded-full text-sm font-medium transition-colors duration-200">
              View Details
            </button>
          </Link>
        </div>
